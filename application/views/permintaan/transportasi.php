...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col my-auto">
            <a class="float-right btn btn btn-primary mb-3" type="button" href="<?= base_url("$role/tTambah") ?>">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="aksi">
                                            ...
                                            ?>
                                                ...
                                                <li><a class="dropdown-item text-danger tombol-hapus" href="<?= base_url('admin/tHapus/') . $row['id'] ?>"><i class="fas fa-fw fa-trash mr-2"></i> Hapus</a></li>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <li><a class="dropdown-item text-danger tombol-hapus" href="<?= base_url('pemeriksa/tHapus/') . $row['id'] ?>"><i class="fas fa-fw fa-trash mr-2"></i> Hapus</a></li>
                                                <?php
                                                }
                                                ?>
                                            ...
                                            ?>
                                                ...
                                                if ($row['user_id'] == $user['id']) {
                                                ?>
                                                    <li><a class="dropdown-item" href="<?= base_url('staff/tEdit/') . $row['id'] ?>"><i class="fas fa-fw fa-edit mr-2"></i> Edit</a></li>
                                                    <li><a class="dropdown-item text-danger tombol-hapus" href="<?= base_url('staff/tHapus/') . $row['id'] ?>"><i class="fas fa-fw fa-trash mr-2"></i> Hapus</a></li>
                                                <?php
                                                }
                                                ?>
                                            <?php
