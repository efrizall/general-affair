            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="divisi" id="divisi" placeholder="Pelayanan Strategis SDM & Umum">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="permintaan" id="permintaan" placeholder="Perbaikan lampu">
                        <?= form_error('permintaan', '<small class="text-danger">', '</small>') ?>
                    </div>
                    <div class="col">
                        <label class="" for="ket">Keterangan atau Barang</label>
                        <input type="text" class="form-control" name="keterangan" id="ket" placeholder="Lampu Philips 15 W">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <label for="tgl_surat">Tanggal Permintaan</label>
                        <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="2022-03-23">
                    ...
                    <div class="col">
                        ...
                        <select name="pemeriksa" id="pemeriksa" class="custom-select">
                            <option selected disabled value="">AVP Pelayanan Strategis SDM & Umum</option>
